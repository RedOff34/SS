...
<%@ page import="file.FileDTO2"%>
<%@ page import="comment.Comment2" %>
<%@ page import="comment.CommentDAO2" %>
...
<body>
	<%
		...
		FileDTO2 f = new FileDAO2().getfileName(bbsID);
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="bbs2.jsp">질문/답변 게시판</a></li>
				<li><a href="bbs3.jsp">스터디그룹 게시판</a></li>
			</ul>
			<%
				if (userID == null) {
			%>
			...
			<table class="table table-striped"
				...
				<tr>
					<td style="width: 20%;">첨부파일</td>
				 	<td colspan="2" style="min-height: 200px; text-align: left;"><a href="filedownload2.jsp?fileName=<%=f.getFileRealName()%>"><%=f.getFileName()%></a></td>
				</tr>
			</table>
				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tr>
						<%
							...
							ArrayList<Comment2> list = commentDAO.getList(boardID, bbsID);
									...
									<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
										...
										<td align="right"><%
												...
												%>
														...
														<a onclick="return confirm('정말로 삭제하시겠습니까?')" href = "commentDeleteAction2.jsp?bbsID=<%=bbsID %>&commentID=<%= list.get(i).getCommentID() %>" class="btn-primary">삭제</a>
