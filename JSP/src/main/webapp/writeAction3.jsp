...
<jsp:useBean id="bbs" class="bbs.Bbs3" scope="page" />
...
<body>
	<% 
		...
		//String directory =this.getClass().getResource("").getPath();
		 ...
		 //directory = directory.substring(1,directory.indexOf(".metadata"))+"BBS/src/main/webapp/upload/group";
		...
		if (userID == null) {
			...
			if (bbs.getBbsTitle() == null || bbs.getBbsContent() == null) {
				...
				new FileDAO3().upload(fileName, fileRealName, bbs.getBbsID());
				...
				if (result == -1) {
					...
					PrintWriter script = response.getWriter();
					script.println("<script>");
					script.print("location.href = 'bbs3.jsp'");
					script.println("</script>");
				}
			}
